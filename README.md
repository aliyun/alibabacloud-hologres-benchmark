...
| [全文检索 - pmc](fulltext_search/pmc/) | PubMed Central 学术文献 | 57 万条 / ~22GB | 基于 Elastic rally-tracks 的 pmc 数据集，评估全文检索性能 |
...
└── fulltext_search/                  # 全文检索场景
    ...
    └── pmc/                          # pmc 数据集
        ├── README.md                 # 详细使用说明
        ├── config.json               # 数据库连接配置模板
        ├── benchmark_queries.yaml    # 基准测试查询定义（6 条查询）
        ├── hologres_benchmark.py     # 基准测试主程序
        ├── data_loader.py            # 多进程数据导入工具
        └── requirements.txt          # Python 依赖
```
...
- [全文检索 - pmc](fulltext_search/pmc/README.md)
